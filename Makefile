...
CFLAGS  ?= -Os -Wall -Wextra -Wno-unused-parameter -Wshadow -Wmissing-prototypes -Wwrite-strings -F/Library/Frameworks
EXPORTDIR ?= .
RANLIB  ?= ranlib
...
PCILIBS += -framework IOKit -L/usr/local/lib -lDirectHW
endif
endif
endif
